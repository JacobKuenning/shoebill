...
OFF can be used as a substitute for a velocity of zero, which means the note is no longer being played: `|ch1,c3,OFF|`

OFF can also be used to turn off all notes that have been played by a particular channel: `|ch4,OFF|`
